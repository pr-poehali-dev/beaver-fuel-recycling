...
const prices = [
  {
    ...
    perkg: "49 ₽/кг",
    highlight: false,
    features: ["Берёзовые брикеты", "Упаковка в плёнку", "Самовывоз или доставка"],
  },
  {
    name: "Популярный",
    qty: "1 паллета",
    ...
    perkg: "37 ₽/кг",
    highlight: true,
    features: ["Берёзовые брикеты", "Плёночная упаковка по 10 кг", "Бесплатная доставка", "Скидка 24%"],
  },
  {
    name: "Оптовый",
    qty: "3 паллеты",
    ...
    perkg: "33 ₽/кг",
    highlight: false,
    features: ["Любой тип брикетов", "Упаковка по согласованию", "Приоритетная доставка", "Скидка 33%", "Персональный менеджер"],
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-6">
              {[
                ...
                { icon: "Mail", label: "Email", value: "info@boberbriket.ru", href: "mailto:info@boberbriket.ru" },
                { icon: "MapPin", label: "Адрес", value: "г. Москва, ул. Лесная, д. 42", href: "#" },
                { icon: "Clock", label: "График работы", value: "Пн–Сб: 8:00 – 19:00", href: "#" },
              ].map(c => (
